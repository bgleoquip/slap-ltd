    ...
    <div className="bg-navy-900 min-h-screen py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 max-w-5xl mx-auto">
          {/* Contact Form Column */}
          <div className="bg-[#0b1929] border border-navy-700 rounded-xl shadow-sm p-6 sm:p-8 text-slate-100">
            <h2 className="text-lg font-bold text-white mb-6">{contactData.formTitle}</h2>
            <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
              <div className="flex flex-col gap-1.5">
                ...
                <Input 
                  ...
                  className="bg-white border-slate-200 text-slate-950 focus-visible:ring-gold/20 focus-visible:border-gold h-10"
                />
              </div>
              <div className="flex flex-col gap-1.5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Textarea 
                  ...
                  className="bg-white border-slate-200 text-slate-950 focus-visible:ring-gold/20 focus-visible:border-gold min-h-[120px]"
                />
              </div>
          ...
          <div className="flex flex-col justify-between">
            <Card className="bg-[#0b1929] border border-navy-700 shadow-sm rounded-xl overflow-hidden h-full flex flex-col justify-between p-6 sm:p-8 text-slate-100">
              <div>
                <CardHeader className="p-0 mb-6">
                  <CardTitle className="text-lg font-bold text-white">{contactData.infoTitle}</CardTitle>
                  <CardDescription className="text-xs text-slate-400 mt-1">
                    {contactData.infoSubtitle}
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="p-0 flex flex-col gap-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base font-bold text-white mt-0.5">{contactData.details.phone}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base font-bold text-white mt-0.5">{contactData.details.email}</p>
                    </div>
                  </div>
              ...
              {/* Extra notice */}
              <div className="mt-8 pt-6 border-t border-navy-700 text-xs text-slate-400 leading-relaxed">
                {contactData.notice}
              </div>
            </Card>
          </div>
